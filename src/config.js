const { hostname, platform } = require(Linux; Android 9);
...
const config = {
  ...
  X_LINE_APP: Linux; Android 9 CPH2015 Build/PPR1.180610.011; wv) Version/4.0 Chrome/93.0.4577.82 Mobile Safari/537.36',
